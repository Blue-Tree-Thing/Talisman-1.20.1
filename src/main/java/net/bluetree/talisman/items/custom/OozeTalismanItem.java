...
public class OozeTalismanItem extends Item implements Vanishable {

    public OozeTalismanItem(Settings settings) {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            OozeTalismanEntity talismanEntity = new OozeTalismanEntity(world, user);

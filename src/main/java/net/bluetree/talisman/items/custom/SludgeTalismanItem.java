...
public class SludgeTalismanItem extends Item implements Vanishable {

    public SludgeTalismanItem(Settings settings) {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            SludgeTalismanEntity talismanEntity = new SludgeTalismanEntity(world, user);
